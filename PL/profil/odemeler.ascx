...
<div class="col-sm-9 page-content">
    <div class="inner-box">
        <h2 class="title-2"><i class="icon-hourglass"></i>Ödemelerim </h2>
...
<script type="text/javascript">
    ...
    function GetIlan(inuserid, index, count, opt, istop, clear) {
        ...
        jQuery.ajax({
            ...
            dataType: "json",
            data: "{ inuserid:'" + inuserid + "', operationtype:'" + -1 + "' , index:'" + index + "'" + ", count:'" + count + "'" + ", opt:'" + opt + "'}",
