...
namespace PL.profil
{
    public partial class magaza_yayinda_olmayan : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                if (Request.QueryString["pass"] != null)
                {
                    ...
                    _ilanManager.UpdateStatus(_adsid, 1, false, false, false);
