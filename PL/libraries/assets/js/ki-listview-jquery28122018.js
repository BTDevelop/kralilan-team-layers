...
var whoList = [
    ...
    { typeId: '7', type: 'emlakcidan' },
    { typeId: '4', type: 'milli-hazineden-(satilamayan)' },
    { typeId: '10', type: 'milli-hazineden-(satisi-devam-eden)' },
    { typeId: '9', type: 'ozellestirme-idaresinden' },
    { typeId: '6', type: 'diger-kamu-kurumlarindan' },
    { typeId: '-1', type: 'tumu' },
];
...
function getListFilterWithAjax(income, intext, index, count, opt, type, clear, istop) {
    ...
    jQuery.ajax({
        type: "POST",
        url: "/services/ki_operation.asmx/getFilter",
        dataType: "json",
        ...
        success: function (data) {
            ...
            if (istop == true) {
                $("#tablebdy").prepend(edata);
            } else {
                $("#tablebdy").append(edata);
            }
