<%@ Page Title="İlan Bilgilerini Doldur - kralilan.com" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="ilan-form.aspx.cs" Inherits="PL.ilan_form1" %>
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="form-horizontal">
                                                                    <div class="well">
                                                                        ...
                                                                        <p>
                                                                            Seninle iletişim kurulması için bir iletişim kanal seçimi yap birçok satıcı sana ulaşmaya çalışacaktır, doğru seçimi yap. 
                                                                                        ...
                                                                                        <div class="radio">
                                                                                            <label>
                                                                                                <input type="radio" name="optionsRadios"
                                                                                                    id="optionsRadios0" value="1" checked required="required" />
                                                                    ...
                                                                    <fieldset>
                                                                        <div class="col-md-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div>
                                                                                    <asp:TextBox ID="txtCKeditorAdi" runat="server" required="required" TextMode="MultiLine" ValidateRequestMode="Disabled"></asp:TextBox>
                                                                                </div>
                                                                            </div>
                                                                            <hr />
                                                                            <div class="form-group">
                                                                                <label for="txtFiyat">Fiyat</label>
                                                                                <asp:TextBox ID="txtFiyat" CssClass="form-control double price" required="required" runat="server"></asp:TextBox>
                                                                            </div>
                                                    ...
                                                    <div class="inner-box category-content">
                                                        ...
                                                        <div class="row">
                                                            <fieldset>
                                                                ...
                                                                <div class="col-md-3">
                                                                    <asp:UpdatePanel runat="server">
                                                                        <ContentTemplate>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label>İlçe</label>
                                                                                <asp:DropDownList CssClass="form-control" required="required" Style="width: 100%;" ID="drpIlce" runat="server" AutoPostBack="true" OnSelectedIndexChanged="drpIlce_SelectedIndexChanged"></asp:DropDownList>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label>Mahalle</label>
                                                                                <asp:DropDownList CssClass="form-control" required="required" Style="width: 100%;" ID="drpMahalle" runat="server"></asp:DropDownList>
                                                                            </div>
                                                                        </ContentTemplate>
                                                                    </asp:UpdatePanel>
                                                                ...
                                                                <div class="col-md-9">
                                                                    <img style="width: 700px; height: 467px; margin-bottom: 20px;" src="/libraries/images/map-polygon.png" />
                                                                </div>
                                                            </fieldset>
                                                        </div>
                                                    </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12 ml-auto">
                                <div class="reg-sidebar-inner text-center">
                                    <div class="promo-text-box">
                                        ...
                                        <h3><strong>İlan Sınırı Aşıldı</strong></h3>
                                        <p>
                                            kralilan.com'da her kategoriden 1 yılda en fazla 3 ücretsiz ilan verebilirsiniz. Anasayfaya devam et, konumundaki ilanlara gözat.                          
                                        </p>
                            ...
                            <div class="col-md-6 ml-auto">
                                <div class="reg-sidebar-inner text-center">
                                    <div class="promo-text-box">
                                        <i class=" icon-credit-card fa fa-4x icon-color-2"></i>
                                        <h3><strong>Ücretli İlan Vermek İstiyorum</strong></h3>
                                        <p>
                                            kralilan.com'da 10 TL ödeyerek 1 ilan vermek için seçimini yap. Yayınla, Paylaş, Satışını yap.                         
                                        </p>
                                        <button type="button" runat="server" onserverclick="priceAds_Click" class="btn btn-info">Devam Et</button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 ml-auto">
                                <div class="reg-sidebar-inner text-center">
                                    <div class="promo-text-box">
                                        ...
                                        <a href="/yeni-magaza/" type="button" class="btn btn-inverse">Devam Et</a>
                                    </div>
                                </div>
                            </div>
                        </div>                   
