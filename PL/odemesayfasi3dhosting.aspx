...
<body>
    ...
    <%
        if ("Approved".Equals(Request.Form.Get("Response")))
        {
            ...
            int odemeId = Convert.ToInt32(Request.Form.Get("oid"));
            BLL.odemeBll odemeb = new BLL.odemeBll();
            BLL.seciliDopingBll secDopingB = new BLL.seciliDopingBll();
            BLL.dopingKategoriBll dopingKatb = new BLL.dopingKategoriBll();
            DAL.odeme _odeme = odemeb.search(odemeId);
            ...
            {
                DAL.dopingKategori _dopKat = dopingKatb.search(siparislist[i].showcasecatid);
