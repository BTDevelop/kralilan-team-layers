<%@ Page Title="Sipariş Onayla - kralilan.com" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="odeme.aspx.cs" Inherits="PL.odeme" %>
        ...
        <div class="dtable hw100">
            <div class="dtable-cell hw100">
                <div class="container text-center">
                    <h1 class="intro-title animated fadeInDown">Siparişlerin Ödemesini Yapabilirsin. </h1>
                    <p style="font-weight: bold;" class="sub animateme fittext3 animated fadeIn">
                        Sepetinde bulunan siparişlerin ödemesini veya iptalini gerçekleştirebilirsin.               
                    </p>
                </div>
            </div>
        </div>
                        ...
                        <div class="wizard-inner">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li role="presentation" class="active">
                                    <a href="#step4" data-toggle="tab" aria-controls="step4" role="tab" title="Hızlı Satışının Karşılığını Gör">
                                        <span class="round-tab">
                                                            ...
                                                            <div class="col-sm-12">
                                                                                ...
                                                                                <table id="example1" class="table table-responsive table-hover">
                                                                                    <thead>
                                                                                        <tr>
                                                                                            ...
                                                                                            <th class="col-md-3" style="font-size: 16px;">Tarih</th>
                                                                                            <th class="col-md-3" style="font-size: 16px;">İşlem</th>
                                                                                        </tr>
                                                                                    </thead>
                                                                                    <tbody>
                                                                                            ...
                                                                                            <ItemTemplate>
                                                                                                <asp:HyperLink NavigateUrl="#" runat="server">
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td>
                                                                                                            <asp:LinkButton ID="OdemeSil" CommandName="Sil" OnClientClick="javascript:if(!confirm('Siparişinizi Sepetinizden Silmek İstediğinizden Emin Misiniz ?'))return false;" CommandArgument='<%#Eval("primarykey") %>' Style="font-size: 14px; color: #343434;" runat="server"><span class="fa fa-close" style="margin-right:5px;"></span>Sepetten Sil</asp:LinkButton>

                                                                                                         <%--   <% if (Eval("vitrinKategori").ToString() != "-1") { %>
                                                                                                            <%} %>--%>
                                                                        ...
                                                                        <div class="modal-dialog">
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    <h4>Siparişlerini Onayla</h4>
                                                                                    <p style="font-size: 16px;">Ödemeni onaylayıp devam etmek istiyor musun? Ayrıca iptal etmek istersen siparişlerini sepetten sil ve ilanını yayına alarak devam et.</p>
                                                                                </div>
                                                                ...
                                                                <div class="well">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="col-md-4 control-label" for="reportName">İsim</label>
                                                                        <div class="col-md-8">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="col-md-4 control-label" for="reportSurname">Soyisim</label>
                                                                        <div class="col-md-8">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="col-md-4 control-label" for="reportIdentityNum">TC Kimlik Numarası</label>
                                                                        <div class="col-md-8">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="col-md-4 control-label" for="reportZipCode">Posta Kodu</label>
                                                                        <div class="col-md-8">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="col-md-4 control-label" for="textarea">Adres</label>
                                                                        <div class="col-md-8">
...
<asp:Content ID="Content3" ContentPlaceHolderID="scripts" runat="server">
    ...
    <script type="text/javascript">
        ...
        function basketNonDelete() {
            $.dialog({
                title: 'Bilgilendirme',
                content: 'Bu işlem gerçekleştirilemez.',
            });
        };
