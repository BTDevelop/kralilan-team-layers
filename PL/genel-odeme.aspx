<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="genel-odeme.aspx.cs" Inherits="PL.genel_odeme" %>
                ...
                <div class="col-md-3 reg-sidebar">
                    <div class="reg-sidebar-inner text-center">
                        <div class="promo-text-box">
                            ...
                            <h3><strong>Ödemeni Hemen Yap</strong></h3>
                            <p>
                                Daha fazla satıcı ve alıcıya ulaş satışının keyfini çıkar.                      
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <div class="page-bottom-info">
        <div class="page-bottom-info-inner">
            <div class="page-bottom-info-content text-center">
                <h1>Ödemler hakkında daha fazla bilgi almak için bize ulaşın</h1>
